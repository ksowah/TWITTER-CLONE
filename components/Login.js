        ...
        <div className='h-screen flex flex-col items-center justify-center'>
            ...
            {Object.values(providers).map((provider) => (
              ...
              <button key={provider.name} 
                    ...
                    className='cursor-pointer relative mt-8 inline-flex items-center justify-start px-6 p-2 overflow-hidden font-medium transition-all bg-black hover:bg-sky-500 group border'>
                        ...
                        <span class="relative w-full text-left text-white transition-colors duration-300 ease-in-out group-hover:text-black flex items-center">Sign in With Google <FcGoogle className="ml-2 text-xl"/></span>
                </button>
