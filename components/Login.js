            ...
            {Object.values(providers).map((provider) => (
              ...
              <button key={provider.name} 
                    ...
                    className='cursor-pointer relative mt-12 inline-flex items-center justify-start px-6 p-2 overflow-hidden font-medium transition-all bg-black hover:bg-white group border'>
                        ...
                        <span className="relative w-full text-left text-white transition-colors duration-300 ease-in-out group-hover:text-black group-hover:font-bold flex items-center">Sign in With Google <FcGoogle className="ml-2 text-xl"/></span>
