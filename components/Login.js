  ...
  return (
      <>
        ...
        <div className="flex flex-col border border-gray-300 h-64 w-72 p-4 items-center justify-center">
            ...
            <a href="#_" class="relative mt-8 inline-flex items-center justify-start px-6 p-2 overflow-hidden font-medium transition-all bg-black hover:bg-white group border">
